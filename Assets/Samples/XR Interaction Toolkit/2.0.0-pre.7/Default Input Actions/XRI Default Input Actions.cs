...
public partial class @XRIActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""Move"",
                    ""type"": ""Value"",
                    ""id"": ""4f0660d3-7275-4fdd-970f-97a9e7b07b37"",
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6aa59b08-f5f3-4b22-923b-eaaeb2e8d76e"",
                    ""path"": ""<Mouse>/delta"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_XRIHMD_Move = m_XRIHMD.FindAction("Move", throwIfNotFound: true);
        // XRI LeftHand
    ...
    private readonly InputAction m_XRIHMD_Move;
    public struct XRIHMDActions
    {
        private @XRIActions m_Wrapper;
        public XRIHMDActions(@XRIActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Position => m_Wrapper.m_XRIHMD_Position;
        public InputAction @Rotation => m_Wrapper.m_XRIHMD_Rotation;
        public InputAction @Move => m_Wrapper.m_XRIHMD_Move;
        ...
        public void SetCallbacks(IXRIHMDActions instance)
        {
            if (m_Wrapper.m_XRIHMDActionsCallbackInterface != null)
            {
                ...
                @Move.started -= m_Wrapper.m_XRIHMDActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_XRIHMDActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_XRIHMDActionsCallbackInterface.OnMove;
            }
    ...
    {
        private @XRIActions m_Wrapper;
        public XRILeftHandActions(@XRIActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @XRIActions m_Wrapper;
        public XRIRightHandActions(@XRIActions wrapper) { m_Wrapper = wrapper; }
